...
JOB_TYPES = {
    ...
    "QA / testing": ["quality assurance", "qa engineer", "qa tester", "tester",
                    ...
                    "qa analyst", "test automation", "qualitätssicherung", "qualitatssicherung", "qualitätsmanagement"],
    "Data / analytics": ["data analyst", "data analytics", "data science",
                        ...
                        "power bi", "tableau", "analytics", "big data", "analista", "risk analyst", "quantitative"],
    ...
    "Development / tech": ["developer", "software engineer", "programmer", "coding",
                          ...
                          "web developer", "bot", "softwareentwickler", "entwickler", "programmierer", "anwendungsentwickler", "cloud engineer", "platform engineer", "site reliability", "sre", "aws", "azure", "kubernetes", "administrador"],
    ...
    "Sales / outreach": ["sales", "salesperson", "sales rep", "sales manager",
                        ...
                        "business development", "closer", "sdr", "bdr", "vertrieb", "vertriebsmitarbeiter", "kundenberater", "außendienst"],
    "Customer support": ["customer support", "customer success", "support agent",
                        ...
                        "call centre", "kundenservice", "kundenbetreuung"],
