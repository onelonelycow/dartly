...
JOB_TYPES = {
    "Video / animation": ["video edit", "video editor", "video editing", "animation",
                          ...
                          "video producer", "videoeditor", "videoschnitt", "cutter",
                          "trickfilmzeichner", "videomontage", "animatiefilm",
                          "videobewerking", "editor de video", "edición de video",
                          "monteur vidéo", "montage vidéo", "editor de vídeo",
                          "edição de vídeo", "montaggio video", "editor video"],
    "Design / creative": ["logo", "brand", "branding", "head of design", "graphic design", "graphic designer",
                          ...
                          "productontwerper", "diseñador gráfico", "diseño gráfico",
                          "diseñador ux", "diseñador de producto", "designer graphique",
                          "graphiste", "designer produit", "directeur artistique",
                          "designer gráfico", "design gráfico", "designer de produto",
    ...
    "Photography": ["photographer", "photography", "photo editor", "photo editing",
                    ...
                    "wedding photographer", "portrait photograph", "fotograf",
                    "fotografie", "produktfotografie", "bildbearbeitung", "fotograaf",
                    "productfotografie", "fotógrafo", "fotografía", "retoque fotográfico",
                    "photographe", "photographie", "retouche photo", "fotografia",
                    "fotografo", "ritocco fotografico"],
    "QA / testing": ["quality assurance", "qa engineer", "qa tester", "tester",
                    ...
                    "qualitätsmanagement", "softwaretester", "testingenieur",
                    "kwaliteitsborging", "testautomatisering", "control de calidad",
                    "probador de software", "pruebas de software", "assurance qualité",
                    "testeur logiciel", "test logiciel", "controle de qualidade",
                    "testador de software", "testes de software", "controllo qualità",
                    "tester software", "collaudatore"],
    "Data / analytics": ["data analyst", "data analytics", "data science",
                        ...
                        "power bi", "tableau", "analytics", "big data", "analista", "risk analyst",
                        "quantitative", "datenanalyst", "datenanalytik", "datenwissenschaftler",
                        "data-analist", "data-analyse", "datawetenschapper",
                        "analista de datos", "ciencia de datos", "científico de datos",
                        "analyste de données", "science des données", "analista de dados",
                        "ciência de dados", "cientista de dados", "analista dati",
                        "scienza dei dati",
                          "ingeniero de datos", "business intelligence", "bi analyst"],
    ...
    "Engineering": ["mechanical engineer", "electrical engineer", "civil engineer",
                    ...
                    "industrial engineer", "manufacturing engineer", "hardware engineer",
                    "design engineer", "project engineer", "field engineer",
                    "maintenance engineer", "electrician", "electrical design",
                    "electrical installation", "pcb", "kicad", "cnc", "welding",
                    "hvac", "ingenieur", "bauingenieur", "elektroniker", "elektriker",
                    "konstrukteur", "maschinenbau", "haustechniker", "monteur",
                    "montagearbeiten", "instandhaltung", "produktionsplanung",
                    "werktuigbouwkundig ingenieur", "elektrotechnisch ingenieur",
                    "installatietechniek", "ingeniero mecánico", "ingeniero eléctrico",
                    "ingeniero civil", "electricista", "ingénieur mécanique",
                    "ingénieur électrique", "ingénieur civil", "électricien",
                    "engenheiro mecânico", "engenheiro elétrico", "engenheiro civil",
                    "eletricista", "ingegnere meccanico", "ingegnere elettrico",
                    "ingegnere civile", "elettricista"],
    "Development / tech": ["developer", "software engineer", "programmer", "coding",
                          ...
                          "web developer", "bot", "softwareentwickler", "entwickler", "programmierer",
                          "anwendungsentwickler", "cloud engineer", "platform engineer",
                          "site reliability", "sre", "aws", "azure", "kubernetes", "administrador",
                          "softwareontwikkelaar", "ontwikkelaar", "programmeur",
                          "desarrollador", "ingeniero de software", "programador",
                          "développeur", "ingénieur logiciel", "programmeur",
                          "desenvolvedor", "engenheiro de software", "sviluppatore",
                          "ingegnere software", "programmatore",
                          "engr", "secops", "site reliability", "platform engineer", "solutions architect", "software development", "ingeniero de software", "integration engineer"],
    "Writing / content": ["writer", "copywriter", "copywriting", "content writer",
                         ...
                         "texter", "redakteur", "lektor", "tekstschrijver", "redacteur",
                         "redactor", "redactor de contenidos", "corrector de textos",
                         "rédacteur", "rédacteur web", "correcteur", "redator",
                         "redator de conteúdo", "revisor de texto", "redattore",
                         "correttore di bozze"],
    "Marketing / SEO": ["marketing", "marketer", "seo", "social media", "ads manager",
                       ...
                       "brand manager", "media buyer", "marketingmanager", "onlinemarketing",
                       "marketingassistent", "social-media-manager", "online marketing",
                       "social media manager", "marketing digital", "gestor de marketing",
                       "especialista en marketing", "responsable marketing",
                       "chargé de marketing", "gestor de marketing", "especialista em marketing",
                       "marketing digitale", "responsabile marketing", "specialista marketing",
                          "paid media", "growth marketing", "demand generation", "lifecycle marketing", "media buyer", "paid social"],
    "Sales / outreach": ["sales", "salesperson", "sales rep", "sales manager",
                        ...
                        "business development", "closer", "sdr", "bdr", "vertrieb", "vertriebsmitarbeiter",
                        "kundenberater", "außendienst", "verkoper", "accountmanager",
                        "salesmedewerker", "representante de ventas", "ejecutivo de cuentas",
                        "commercial", "représentant commercial", "chargé de clientèle",
                        "representante de vendas", "executivo de contas",
    ...
    "Customer support": ["customer support", "customer success", "support agent",
                        ...
                        "call centre", "kundenservice", "kundenbetreuung", "klantenservice",
                        "klantondersteuning", "atención al cliente", "servicio al cliente",
                        "soporte al cliente", "service client", "support client",
                        "relation client", "atendimento ao cliente", "suporte ao cliente",
    ...
    "Product / PM": ["product manager", "project manager", "program manager", "scrum",
                    "product owner", "scrum master", "delivery manager", "projektmanager", "projektleiter", "teilprojektleiter", "projektleitung",
                    "productmanager", "projectmanager", "projectleider", "gerente de producto",
                    "gerente de proyecto", "jefe de proyecto", "chef de produit",
                    "chef de projet", "gerente de produto", "gerente de projeto",
                    "responsabile di progetto",
                          "product management", "product operations", "technical program"],
    "Admin / VA": ["virtual assistant", "va", "administrative", "admin assistant",
                  ...
                  "back office", "sachbearbeiter", "verwaltungsfachkraft", "disposition", "büro", "sekretariat",
                  "administratief medewerker", "receptioniste", "asistente virtual",
                  "asistente administrativo", "auxiliar administrativo",
                  "assistant administratif", "secrétaire", "assistant virtuel",
                  "assistente virtual", "assistente administrativo",
                  "auxiliar administrativo", "assistente amministrativo", "segretaria"],
    "Audio / music": ["voice over", "voiceover", "audio edit", "podcast", "music prod",
                     "mixing", "sound design", "audio engineer", "music producer",
                     "tonmeister", "toningenieur", "synchronsprecher", "geluidstechnicus",
                     "audiomontage", "ingeniero de sonido", "locutor",
                     "producción musical", "ingénieur du son", "monteur son", "voix off",
                     "engenheiro de som", "produção musical", "tecnico del suono",
                     "doppiatore", "produzione musicale"],
    "Finance / accounting": ["accountant", "accounting", "bookkeeper", "bookkeeping",
                            ...
                            "fp&a", "accounts payable", "accounts receivable", "steuerberater", "steuerfachangestellte", "buchhalter", "buchhaltung", "finanzbuchhaltung", "lohnbuchhaltung", "kreditsachbearbeiter", "bilanzbuchhalter", "steuerassistent",
                            "boekhouder", "boekhouding", "financieel analist", "contador",
                            "contabilidad", "analista financiero", "comptable", "comptabilité",
                            "analyste financier", "contabilidade", "analista financeiro",
                            "contabile", "contabilità", "analista finanziario",
                          "loan officer", "loan manager", "underwriter", "billing specialist", "revenue cycle", "accounts payable", "accounts receivable"],
    "HR / recruiting": ["human resources", "recruiter", "recruiting", "recruitment",
                       "talent acquisition", "headhunter", "hr", "sourcer",
                       "people operations", "hr manager", "personalreferent", "personalwesen", "personalsachbearbeiter",
                       "hr-medewerker", "personeelszaken", "reclutador", "recursos humanos",
                       "selección de personal", "recruteur", "ressources humaines",
                       "chargé de recrutement", "recursos humanos", "seleção de pessoal",
                       "risorse umane", "selezione del personale",
                          "benefits analyst", "compensation and benefits", "talent acquisition", "people operations", "sourcing specialist", "benefits partner"],
    "Legal": ["lawyer", "attorney", "paralegal", "legal", "counsel", "litigation",
             "compliance", "contract drafting", "legal drafting", "solicitor",
             "notary", "rechtsanwalt", "vertragsrecht", "advocaat", "juridisch medewerker",
             "abogado", "asesoría legal", "avocat", "droit des contrats",
             "advogado", "direito contratual", "avvocato", "diritto contrattuale"],
    "Healthcare / medical": ["nurse", "clinical", "medical", "healthcare", "physician",
                            "therapist", "caregiver", "pharmacist", "dental", "dentist",
                            "health agency", "medical device", "clinical research", "pflegefachkraft", "pflegekraft", "krankenpfleger", "altenpfleger", "arzthelferin", "psychiatrist", "psychologist", "radiology", "radiographer", "sonographer", "ct tech", "veterinar", "physiotherap", "occupational therap", "paramedic", "midwife", "optometr",
                            "verpleegkundige", "zorgverlener", "enfermero", "médico", "cuidador",
                            "infirmier", "médecin", "aide-soignant", "enfermeiro", "cuidador",
                            "infermiere", "medico", "operatore sanitario",
                          "mental health", "behavioral health", "registered nurse", "lpn", "lvn", "lcsw", "lmft", "clinician", "patient care", "provider enrollment", "pharmacist", "physician", "utilization review", "home health", "claims adjuster", "medical claims"],
    "Architecture / 3D": ["architect", "interior design", "floor plan", "furniture design",
                         "3d model", "3d artist", "rendering", "autocad", "revit",
                         "blender", "cad", "landscape design", "sketchup", "architekt",
                         "innenarchitekt", "3d-visualisierung", "interieurontwerper",
                         "3d-visualisatie", "arquitecto", "diseño de interiores",
                         "visualización 3d", "architecte", "architecte d'intérieur",
                         "visualisation 3d", "arquiteto", "design de interiores",
                         "visualização 3d", "architetto", "visualizzazione 3d"],
    "IT / support": ["sysadmin", "system administrator", "it support", "network admin",
                    "it technician", "helpdesk", "it-system", "technical support", "security engineer", "cybersecurity", "cyber security", "information security", "infosec", "soc analyst", "penetration test", "security analyst", "security specialist",
                    "systemadministrator", "netzwerkadministrator", "systeembeheerder",
                    "it-ondersteuning", "netwerkbeheerder", "administrador de sistemas",
                    "soporte técnico", "administrador de red", "administrateur systèmes",
                    "support informatique", "administrateur réseau", "suporte técnico",
                    "administrador de rede", "amministratore di sistema",
                    "supporto tecnico", "amministratore di rete",
                          "systems administrator", "sysadmin", "system administrator", "infosec", "security operations", "service desk", "field service technician", "identity management"],
    "Consulting / strategy": ["consultant", "strategy", "advisor", "founders associate",
                             "management consultant", "business analyst", "strategist", "berater", "beraterin", "beratung", "unternehmensberatung", "head of strategy",
                             "adviseur", "strategie", "consultor", "asesor", "estrategia",
                             "conseiller", "stratégie", "assessor", "estratégia",
                             "consulente", "consulenza", "strategia"],
    "Teaching / tutoring": ["tutor", "teacher", "instructor", "curriculum", "lesson plan",
                           "e-learning", "course creator", "teaching", "professor",
                           "trainer", "coach", "lehrer", "nachhilfe", "dozent", "docent",
                           "bijles", "leraar", "profesor", "clases particulares",
                           "tuteur", "cours particuliers", "aulas particulares",
                           "insegnante", "lezioni private"],
    ...
    "Management / operations": ["head of", "director", "vp of", "vice president",
        ...
        "gerente de operaciones", "jefe de equipo", "responsable des opérations",
        "chef d'équipe", "diretor", "gerente de operações", "chefe de equipe",
        "responsabile operativo", "capo squadra",
                          "operations manager", "business operations", "revenue operations", "operations specialist", "operations analyst", "operations lead"],
    "Translation / language": ["translator", "translation", "localization", "interpreter",
                              ...
                              "vertaling", "tolk", "traductor", "traducción", "intérprete",
                              "traducteur", "traduction", "interprète", "tradutor",
                              "tradução", "traduttore", "traduzione",
                          "transcriber", "linguist", "linguistics", "interpreting", "audio transcription", "conversation transcription"],
}
